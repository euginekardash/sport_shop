...
class OrderModel{
  ...
  String get formattedOrderDate => MyHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate => deliveryDate != null ? MyHelperFunctions.getFormattedDate(deliveryDate!) : '';
